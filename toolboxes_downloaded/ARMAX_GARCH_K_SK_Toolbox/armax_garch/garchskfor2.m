function [VF, SF, KF, VC] = garchskfor2(data, resids, ht, sk, ku, parameters,p, q, max_forecast)
%{
-----------------------------------------------------------------------
 PURPOSE: 
...
if nargin == 0 
    error('Data, Residuals, Variance, Skewness, Kurtosis, GARCH, Maximum Number of Forecasts') 
end
