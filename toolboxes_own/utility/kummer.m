...
%
% Copyright Patrick Mousaw
% 
% Patrick Mousaw (2020). Confluent hypergeometric function 
% (https://www.mathworks.com/matlabcentral/fileexchange/29766-confluent-hypergeometric-function), 
% MATLAB Central File Exchange. Retrieved July 21, 2020. 

error("Doesn't work properly for b inputs <= 0. Idk if it should or not.")
