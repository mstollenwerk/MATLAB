function [eparam, tstats, logL, optimoutput] = ...
    mvsymghyperbolicest(data_mat, x0, varargin)
...
lb = [ -inf(p+p_,1); -inf; 0; 0 ]';

[eparam,optimoutput] = ...
    my_fmincon( ...
        @(param) mvsymghyperboliclike( [], [], [], [], [], data_mat, param ), ...
        x0, ...
        [],[],[],[],lb,[],[],varargin{:} ...
    );
%% tstats
...
[VCV,scores,gross_scores] = ...
    vcv(@(param) mvsymghyperboliclike( [], [], [], [], [], data_mat, param ), eparam);
...
[nLogL, logLcontr, ~, ~, eparam ] = ...
    mvsymghyperboliclike( [], [], [], [], [], data_mat, eparam );
