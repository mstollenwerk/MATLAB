function [ mF_rnd ] = mFrnd( Sigma_, df_1, df_2 )
%MNCFRND
%
% USAGE:
%  [ mF_rnd ] = mFrnd( Sigma_, df_1, df_2)
%
% COMMENTS:
%   See also mFlike mncFrnd mncFlike
%
%   This is the same as using mncFrnd with Omega_ = zeros(K,K,N)
%
% DEPENDENCIES:
%   iwishrnd, mvnrnd or wishrnd [Statistics and Machine Learning Toolbox R2017b]
