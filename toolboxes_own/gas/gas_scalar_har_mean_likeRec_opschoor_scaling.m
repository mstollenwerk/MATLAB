function [ nLogL, logLcontr, dyn, S, varargout ] = ...
    gas_scalar_har_mean_likeRec_opschoor_scaling( param, R, dist )
%
% Michael Stollenwerk
...
par = gas_scalar_har_mean_param_transform_opschoor_scaling(dist,param,p);
...
%         {ME.stack.name}'
    ...
    Sig_score(:,:,tt) = SigDelSig+SigDelSig';
